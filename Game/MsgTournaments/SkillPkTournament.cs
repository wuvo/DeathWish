            ...
            foreach (var tournament in EliteGroups)
            {
                ...
                if (tournament.GetReward(client, out Rank))
                {
                    ...
                    if (Rank == 1)
                    {
                        ...
                        client.Inventory.Add(stream, 721308, 1);
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " : level 140 on Skill Team Tournament and claimed 50000 Conquer Points  .";
                    ...
                    if (Rank == 2)
                    {
                        ...
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " : lev 140 on Skill Team Tournament and claimed 30000 Conquer Points .";
                        Program.SendGlobalPackets.Enqueue(new MsgMessage(MSG, MsgMessage.MsgColor.red, MsgMessage.ChatMode.System).GetArray(stream));
                    ...
                    if (Rank == 3)
                    {
                        ...
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " : lev 140 on Skill Team Tournament and claimed 20000 Conquer Points  .";
                        Program.SendGlobalPackets.Enqueue(new MsgMessage(MSG, MsgMessage.MsgColor.red, MsgMessage.ChatMode.System).GetArray(stream));
                    ...
                    if (Rank == 5)
                    {
                        ...
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " : lev 140 on Skill Team Tournament and claimed 15000 Conquer Points .";
                        Program.SendGlobalPackets.Enqueue(new MsgMessage(MSG, MsgMessage.MsgColor.red, MsgMessage.ChatMode.System).GetArray(stream));
