...
namespace DeathWish.Game.MsgTournaments
{
    public class MsgMonkClass
    {
        ...
        {
            Furnitures.Add(Role.SobNpc.StaticMesh.Pole, Database.Server.ServerMaps[MapID].View.GetMapObject<Role.SobNpc>(Role.MapObjectType.SobNpc, 22804));
        }
        ...
        public static void Start()
        {
            ...
            MsgSchedules.SendInvitation("ClassPoleWar ", "Special Reward", 379, 320, 1002, 0, 500);
            MsgSchedules.SendSysMesage("ClassPoleWar has been begun .");
        }
        ...
        public static void CheckUP()
        {
            ...
            if (Proces == ProcesType.Alive)
            {
                ...
                if (Now.Hour == 03 && Now.Minute == 45 && Now.Second >= 01 || Now.Hour == 06 && Now.Minute == 45 && Now.Second >= 01 || Now.Hour == 09 && Now.Minute == 45 && Now.Second >= 01 || Now.Hour == 12 && Now.Minute == 45 && Now.Second >= 01 || Now.Hour == 15 && Now.Minute == 45 && Now.Second >= 01 || Now.Hour == 18 && Now.Minute == 45 && Now.Second >= 01 || Now.Hour == 21 && Now.Minute == 45 && Now.Second >= 01 || Now.Hour == 00 && Now.Minute == 45 && Now.Second >= 01)
                    MsgSchedules.SendSysMesage("ClassPoleWar will ended after 15 Minutes.", MsgServer.MsgMessage.ChatMode.Center);

                if (Now.Hour == 03 && Now.Minute == 50 && Now.Second >= 01 || Now.Hour == 06 && Now.Minute == 50 && Now.Second >= 01 || Now.Hour == 09 && Now.Minute == 50 && Now.Second >= 01 || Now.Hour == 12 && Now.Minute == 50 && Now.Second >= 01 || Now.Hour == 15 && Now.Minute == 50 && Now.Second >= 01 || Now.Hour == 18 && Now.Minute == 50 && Now.Second >= 01 || Now.Hour == 21 && Now.Minute == 50 && Now.Second >= 01 || Now.Hour == 00 && Now.Minute == 50 && Now.Second >= 01)
                    MsgSchedules.SendSysMesage("ClassPoleWar will ended after 10 Minutes.", MsgServer.MsgMessage.ChatMode.Center);

                if (Now.Hour == 03 && Now.Minute == 55 && Now.Second >= 01 || Now.Hour == 06 && Now.Minute == 55 && Now.Second >= 01 || Now.Hour == 09 && Now.Minute == 55 && Now.Second >= 01 || Now.Hour == 12 && Now.Minute == 55 && Now.Second >= 01 || Now.Hour == 15 && Now.Minute == 55 && Now.Second >= 01 || Now.Hour == 18 && Now.Minute == 55 && Now.Second >= 01 || Now.Hour == 21 && Now.Minute == 55 && Now.Second >= 01 || Now.Hour == 00 && Now.Minute == 45 && Now.Second >= 01)
                    MsgSchedules.SendSysMesage("ClassPoleWar will ended after 5 Minutes.", MsgServer.MsgMessage.ChatMode.Center);
        ...
        public static void FinishRound(ServerSockets.Packet stream)
        {
            ...
            MsgSchedules.SendSysMesage("The [ Monk ] Round Ownered by " + RoundOwner.Name + ".", MsgServer.MsgMessage.ChatMode.Center);
            Reset(stream);
        }
