...
namespace DeathWish.Game.MsgTournaments
{
    public class MsgDragonClass
    {
        ...
        {
            Furnitures.Add(Role.SobNpc.StaticMesh.Pole, Database.Server.ServerMaps[MapID].View.GetMapObject<Role.SobNpc>(Role.MapObjectType.SobNpc, 22802));
        }
        ...
        public static void FinishRound(ServerSockets.Packet stream)
        {
            ...
            MsgSchedules.SendSysMesage("The [ DragonWarrior ] Round Ownered by " + RoundOwner.Name + ".", MsgServer.MsgMessage.ChatMode.Center);
            Reset(stream);
        }
