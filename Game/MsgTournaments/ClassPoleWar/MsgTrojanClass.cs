...
namespace DeathWish.Game.MsgTournaments
{
    public class MsgTrojanClass
    {
        ...
        {
            Furnitures.Add(Role.SobNpc.StaticMesh.Pole, Database.Server.ServerMaps[MapID].View.GetMapObject<Role.SobNpc>(Role.MapObjectType.SobNpc, 22807));
        }
        ...
        public static void FinishRound(ServerSockets.Packet stream)
        {
            ...
            MsgSchedules.SendSysMesage("The [ Trojan ] Round Ownered by " + RoundOwner.Name + ".", MsgServer.MsgMessage.ChatMode.Center);
            Reset(stream);
        }
