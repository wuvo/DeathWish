...
namespace DeathWish.Game.MsgTournaments
{
    public class MsgArcherClass
    {
        ...
        {
            Furnitures.Add(Role.SobNpc.StaticMesh.Pole, Database.Server.ServerMaps[MapID].View.GetMapObject<Role.SobNpc>(Role.MapObjectType.SobNpc, 22801));
        }
        ...
        public static void FinishRound(ServerSockets.Packet stream)
        {
            ...
            MsgSchedules.SendSysMesage("The [ Archer ] Round Ownered by " + RoundOwner.Name + ".", MsgServer.MsgMessage.ChatMode.Center);
            Reset(stream);
        }
