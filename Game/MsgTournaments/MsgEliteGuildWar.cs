...
namespace DeathWish.Game.MsgTournaments
{
    public class MsgEliteGuildWar
    {
        ...
        public void CheckUP()
        {
           ...
           // if (Proces == ProcesType.Dead && Now.Hour == 19 && Now.Minute == 00 && Now.Second == 01 )
             //  this.Start();
        ...
        public void Start()
        {
            ...
            MsgSchedules.SendInvitation("EliteGuildWar has begun! Would you like to join?", "Each Pole Gives [10750 Cps & 50 HORUS-Coins ]  ", 419, 260, 1002, 0, 120);
        }
