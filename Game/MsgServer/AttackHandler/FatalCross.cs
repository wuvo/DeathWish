                    ...
                    case (ushort)Role.Flags.SpellID.FatalCross:
                        {
                            ...
                            foreach (Role.IMapObj target in user.Player.View.Roles(Role.MapObjectType.Monster))
                            {
                                ...
                                if (Role.Core.GetDistance(user.Player.X, user.Player.Y, attacked.X, attacked.Y) < DBSpell.Range*2)
                                {
                            ...
                            foreach (Role.IMapObj targer in user.Player.View.Roles(Role.MapObjectType.Player))
                            {
                                ...
                                if (Role.Core.GetDistance(user.Player.X, user.Player.Y, targer.X, targer.Y) < DBSpell.Range*2)
                                {
                                    if (Line.InLine(attacked.X, attacked.Y, LineRange))
                                    {
