...
{
    public class CityWarTc
    {
        public static bool signup = false;
        public static bool TCPrize = false;
        ...
        public static void Init()
        {
            ...
            ThePole = new SOB() { EntityID = 6727, Type = Looks.Pole, Mesh = 1137, CurHP = 10000000, MaxHP = 10000000, Loc = new Location() { Map = 8505, X = 162, Y = 217 }, War = false, LastWinner = LastWinner };
            ThePole.AddSOB();
        ...
        public static void StartWar()
        {
            ...
            loadstats();
            //World.SendMsgToAll("SYSTEM", "CityWarTC has begun! Talk to ObscureWarrior in TwinCity to join!", 2011, 0);
            War = true;
        }
        ...
        public static void EndWarForGood()
        {
            ...
            if (LastWinner != null)
            {
                World.SendMsgToAll("SYSTEM", LastWinner.GuildName + " have won the TwinCity War! Congratulations!", 2011, 0);
                World.SendMsgToAll("SYSTEM", LastWinner.GuildName + " have won the TwinCity War! Congratulations!", 2000, 0);
            }
            else
                World.SendMsgToAll("SYSTEM", "The CityWarTC has ended and there were no winners!", 2000, 0);
        }
        ...
        public static void PoleTakedown()
        {
            ...
            if (Highest.TheGuild != null)
            {
                ...
                World.SendMsgToAll("SYSTEM", LastWinner.GuildName + " TwinCity War have won!", 2011, 0);
                World.SendMsgToAll("SYSTEM", LastWinner.GuildName + " TwinCity War have won!", 2000, 0);
                //World.SendMsgToAll("SYSTEM", "CityWarTC started!", 2000, 0);
            }
