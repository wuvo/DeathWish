...
{
    public class CityWarPc
    {
        public static bool signup = false;
        public static bool PCPrize = false;
        ...
        public static void Init()
        {
            ...
            ThePole = new SOB() { EntityID = 6728, Type = Looks.Pole, Mesh = 1137, CurHP = 10000000, MaxHP = 10000000, Loc = new Location() { Map = 8509, X = 82, Y = 119 }, War = false, LastWinner = LastWinner };
            ThePole.AddSOB();
        ...
        public static void StartWar()
        {
            ...
            loadstats();
            //World.SendMsgToAll("SYSTEM", "CityWarPc has begun! Talk to ObscureWarrior in TwinCity to join!", 2011, 0);
            War = true;
        }
        ...
        public static void EndWarForGood()
        {
            ...
            foreach (Character C in World.H_Chars.Values)
                if (C.Loc.Map == 8509)
                    C.Teleport(1011, 232, 260);
            if (LastWinner != null)
            {
                World.SendMsgToAll("SYSTEM", LastWinner.GuildName + " have won the PhoenixCastle War! Congratulations!", 2011, 0);
                World.SendMsgToAll("SYSTEM", LastWinner.GuildName + " have won the PhoenixCastle War! Congratulations!", 2000, 0);
            }
            else
                World.SendMsgToAll("SYSTEM", "The CityWarPc has ended and there were no winners!", 2000, 0);
        }
        ...
        public static void PoleTakedown()
        {
            ...
            if (Highest.TheGuild != null)
            {
                ...
                World.SendMsgToAll("SYSTEM", LastWinner.GuildName + " PhoenixCastle War have won!", 2011, 0);
                World.SendMsgToAll("SYSTEM", LastWinner.GuildName + " TwinCity War have won!", 2000, 0);
                //World.SendMsgToAll("SYSTEM", "CityWarPc started!", 2000, 0);
            }
