...
namespace NewestCOServer.Features
{
    public class CounterClock
    {
        ...
        public struct Gates
        {
            ...
            public void TakeAttack(Character C, uint Damage, byte AtkType)
            {
                ...
                if (Damage >= CurHP)
                {
                    ...
                    if (!Opened)
                    {
                        if (EntityID == 6725 || EntityID == 6724 || EntityID == 6723)
                        {
                            if (RG17.CurHP == 0 && RG16.CurHP == 0 && RG15.CurHP == 0)
                            {
                                RG17.Opened = true;
                                RG16.Opened = true;
                                RG15.Opened = true;
                        ...
                        else if (EntityID == 6722 || EntityID == 6721 || EntityID == 6720)
                        {
                            if (RG12.CurHP == 0 && RG13.CurHP == 0 && RG14.CurHP == 0)
                            {
                                RG12.Opened = true;
                                RG13.Opened = true;
                                RG14.Opened = true;
                        ...
                        else if (EntityID == 6719 || EntityID == 6718 || EntityID == 6717)
                        {
                            if (RG9.CurHP == 0 && RG10.CurHP == 0 && RG11.CurHP == 0)
                            {
                                RG9.Opened = true;
                                RG10.Opened = true;
                                RG11.Opened = true;
            ...
            public void TakeAttack(Companion C, uint Damage, byte AtkType)
            {
                ...
                if (Damage >= CurHP)
                {
                    ...
                    if (!Opened)
                    {
                        if (EntityID >= 6717 && EntityID <= 6725)
                        {
                            if (RG17.CurHP == 0 && RG16.CurHP == 0 && RG15.CurHP == 0)
                            {
                                RG17.Opened = true;
                            ...
                            else if (RG12.CurHP == 0 && RG13.CurHP == 0 && RG14.CurHP == 0)
                            {
                                RG12.Opened = true;
                                RG13.Opened = true;
                                RG14.Opened = true;
                            ...
                            else if (RG9.CurHP == 0 && RG10.CurHP == 0 && RG11.CurHP == 0)
                            {
                                RG9.Opened = true;
                                RG10.Opened = true;
                                RG11.Opened = true;
        ...
        public static Gates RG19;
        public static Gates RG18;
        public static Gates RG17;
        public static Gates RG16;
        public static Gates RG15;
        public static Gates RG14;
        public static Gates RG13;
        public static Gates RG12;
        public static Gates RG11;
        public static Gates RG10;
        public static Gates RG9;
        public static Gates RG8;
        public static Gates RG7;
        public static Gates RG6;
        public static Gates RG5;
        public static Gates RG4;
        public static Gates RG3;
        public static Gates RG2;
        public static Gates RG1;
        public static Gates LG6;
        public static Gates LG5;
        public static Gates LG4;
        ...
        public static void StartWar()
        {
            ...
            RG16.ReSpawn();
            loadstats();
            World.SendMsgToAll("SYSTEM", "Counter Clock War has begun!", 2011, 0);
            War = true;
            Teleport();
            //loadstats();
            ...
            try
            {
                ...
                foreach (Character C in World.H_Chars.Values)
                {
                    if (C.Loc.Map == 1090)
                    {
                        ...
                        C.Teleport(1844, (ushort)(225 + Program.Rnd.Next(1, 8) - Program.Rnd.Next(1, 8)), Y);
                        C.Protection = false;
                    }
                }
            }
