                ...
                if (Started70To99)
                    {
                        ...
                        if (TeamsInside70To99.Count >= 1)
                        {
                                       ...
                                       // Console.WriteLine("Giving Reward to the alive team!");
                                        if (Game.World.LowRatedServer)
                                        {
                                            if (MyMath.ChanceSuccess(90))
                                            {
                                               ...
                                               // {
                                                    T.Leader.DBScrolls += 2;
                                                    T.Leader.MyClient.LocalMessage(2000, "Please check Prize NPC in market in order to pick up your 2 DBs!");
                                              //  }
                                              /*  else
                                                {
                                                    T.Leader.MyClient.LocalMessage(2000, "Your inventory was full! Talk to Vale[PM] or check the forum to receive your reward!");
                                                    Program.WriteCmds(T.Leader.Name + " did not receive Team PK reward: 2 DBs ");
                                                }*/
                                                Game.World.SendMsgToAll("TeamPK", "The Team whose leader is " + T.Leader.Name + " has won the Team PK Tournament (70-99) and 2 DragonBalls! Congratulations!", 2005, 0);
                                            }
                                            else
                                            {
                                                ...
                                                Game.World.SendMsgToAll("TeamPK", "The Team whose leader is " + T.Leader.Name + " has won the Team PK Tournament (70-99) and 1 socketed item! Congratulations!", 2005, 0);
                                        ...
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                Game.World.SendMsgToAll("TeamPK", "The Team whose leader is " + T.Leader.Name + " has won the Team PK Tournament (70-99) and 2 socketed item! Congratulations!", 2005, 0);
                            ...
                            else if (DateTime.UtcNow >= Start.AddMinutes(10))
                            {
                                    ...
                                    if (T.PKTournyAlive)
                                    {
                                        ...
                                        if (Game.World.LowRatedServer)
                                        {
                                            if (MyMath.ChanceSuccess(90))
                                            {
                                              ...
                                              /*  if (T.Leader.Inventory.Count < 39)
                                                ...
                                                Game.World.SendMsgToAll("TeamPK", "The Team whose leader is " + T.Leader.Name + " has won the Team PK Tournament (100-115) and 2 DragonBalls! Congratulations!", 2005, 0);
                                            }
                                            else
                                            {
                                                if (T.Leader.Inventory.Count < 40)
                                                ...
                                                Game.World.SendMsgToAll("TeamPK", "The Team whose leader is " + T.Leader.Name + " has won the Team PK Tournament (100-115) and 1 socketed item! Congratulations!", 2005, 0);
                                        ...
                                        else
                                        {
                                            if (MyMath.ChanceSuccess(99))
                                            {
                                                ...
                                                Game.World.SendMsgToAll("TeamPK", "The Team whose leader is " + T.Leader.Name + " has won the Team PK Tournament (100-115) and 1 Super Gem! Congratulations!", 2005, 0);
                                            }
                                            else
                                            {
                                                if (T.Leader.Inventory.Count < 40)
                                                ...
                                                Game.World.SendMsgToAll("TeamPK", "The Team whose leader is " + T.Leader.Name + " has won the Team PK Tournament (100-115) and 2 socketed item! Congratulations!", 2005, 0);
                                      ...
                                      }*/
                                    {
                                        ...
                                        if (Game.World.LowRatedServer)
                                        {
                                            if (MyMath.ChanceSuccess(90))
                                            {
                                              ...
                                              /*  if (T.Leader.Inventory.Count < 39)
                                                ...
                                                Game.World.SendMsgToAll("TeamPK", "The Team whose leader is " + T.Leader.Name + " has won the Team PK Tournament (116-130) and 2 DragonBalls! Congratulations!", 2005, 0);
                                            }
                                            else
                                            {
                                                if (T.Leader.Inventory.Count < 40)
                                                ...
                                                Game.World.SendMsgToAll("TeamPK", "The Team whose leader is " + T.Leader.Name + " has won the Team PK Tournament (116-130) and 1 socketed item! Congratulations!", 2005, 0);
                                        ...
                                        else
                                        {
                                            if (MyMath.ChanceSuccess(99))
                                            {
                                                ...
                                                Game.World.SendMsgToAll("TeamPK", "The Team whose leader is " + T.Leader.Name + " has won the Team PK Tournament (116-130) and 1 Super Gem! Congratulations!", 2005, 0);
                                            }
                                            else
                                            {
                                                if (T.Leader.Inventory.Count < 40)
                                                ...
                                                Game.World.SendMsgToAll("TeamPK", "The Team whose leader is " + T.Leader.Name + " has won the Team PK Tournament (116-130) and 2 socketed item! Congratulations!", 2005, 0);
