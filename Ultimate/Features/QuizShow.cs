...
//                {
//                    Question Q = AllQuestions[(ushort)Gen];
...
//                            (ushort)(800 * GC.MyChar.QuizShowInfo.Score / 100), 1, nextq, QuizShow.Questions[QuestionNO], QuizShow.Questions[QuestionNO].Answers[0], QuizShow.Questions[QuestionNO].Answers[1], QuizShow.Questions[QuestionNO].Answers[2], QuizShow.Questions[QuestionNO].Answers[3]));
