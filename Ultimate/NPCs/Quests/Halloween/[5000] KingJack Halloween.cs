...
{
    public class NPC_5000 : NPCBase
    {
        public NPC_5000(Main.GameClient _client)
            : base(_client)
        {
            ID = 5000;
            Face = 7;
        ...
        public override void Run(Main.GameClient GC, byte[] _data, ushort _linkback)
        {
            ...
            switch (_linkback)
            {
                case 0:
                    {
                        AddText("Trick or treat? Halloween is here ! Have you noticed the pumpkins dropping from monsters? ");
