...
{
    public class NPC_780001 : NPCBase
    {
        public NPC_780001(Main.GameClient _client)
            : base(_client)
        {
            ID = 780001;
            Face = 1;
                ...
                case 2:
                    {
                        ...
                        GC.MyChar.VIPDays = 0;
                        AddText("Your vip days have been successfully reset. You can use now your Vip.");
                ...
                case 1:
                    {
                        if (GC.MyChar.VipLevel != 3)
                        {
                            if (GC.MyChar.RemoveItem(GC.MyChar.VIPUsage.UID))
                            {
                                ...
                                GC.MyChar.VipLevel = GC.MyChar.VIPUsage.Bless;
                                GC.MyChar.VIPDays += GC.MyChar.VIPUsage.Plus;
                        ...
                        {
                            AddText("You have already VIP for Mining, if you want to use Vip we need to reset your vip Days and Level. Are you sure ?");
