...
{
    public class NPC_67000 : NPCBase
    {
        public NPC_67000(Main.GameClient _client)
            : base(_client)
        {
            ID = 67000;
            Face = 30;
                ...
                case 1:
                    {
                        if (GC.MyChar.MyGuild != null)
                        {
                            ...
                            {
                                if (GC.MyChar.MyGuild.GuildID == Features.TCGuildWars.LastWinner.GuildID && (GC.MyChar.GuildRank == Ultimate.Features.GuildRank.GuildLeader || GC.MyChar.GuildRank == Ultimate.Features.GuildRank.DeputyManager))
                                {
