...
{
    public class NPC_67002 : NPCBase
    {
        public NPC_67002(Main.GameClient _client)
            : base(_client)
        {
            ID = 67002;
            Face = 30;
                ...
                case 1:
                    {
                        if (GC.MyChar.MyGuild != null)
                        {
                            if (Features.TCGuildWars.LastWinner != null)
                            {
                                ...
                                {
                                    if (Features.TCGuildWars.TheRightGate.CurHP > 0)
                                    {
                                        World.H_SOBs[Features.TCGuildWars.TheRightGate.EntityID].Opened = !World.H_SOBs[Features.TCGuildWars.TheRightGate.EntityID].Opened;
                ...
                case 2:
                    {
                        if (GC.MyChar.MyGuild != null)
                        {
                            if (Features.TCGuildWars.LastWinner != null)
                            {
                                ...
                                {
                                    if (GC.MyChar.Alive)
                                        GC.MyChar.Teleport(10200, 484, 356);
                                }
                                else
                                {
                ...
                case 3:
                    {
                        if (GC.MyChar.MyGuild.Fund >= 5000000)
                        {
                            ...
                            World.H_SOBs[Features.TCGuildWars.TheRightGate.EntityID].CurHP = World.H_SOBs[Features.TCGuildWars.TheRightGate.EntityID].MaxHP;
                            World.H_SOBs[Features.TCGuildWars.TheRightGate.EntityID].Opened = false;
                            World.H_SOBs[Features.TCGuildWars.TheRightGate.EntityID].ReSpawn();
                ...
                case 4:
                    {
                        if (GC.MyChar.InventoryContains(721261, 1))
                        {
                            if (MyMath.PointDistance(GC.MyChar.Loc.X, GC.MyChar.Loc.Y, 163, 210) <= 8)
                            {
                                ...
                                if (Features.TCGuildWars.TheRightGate.CurHP > 2500000)
                                {
                                    Features.TCGuildWars.TheRightGate.CurHP -= 5000000;
