...
{
    public class NPC_6702 : NPCBase
    {
        public NPC_6702(Main.GameClient _client)
            : base(_client)
        {
            ID = 6702;
            Face = 30;
                ...
                case 1:
                    {
                        if (GC.MyChar.MyGuild != null)
                        {
                            if (Features.GuildWars.LastWinner != null)
                            {
                                ...
                                {
                                    if (Features.GuildWars.TheRightGate.CurHP > 0)
                                    {
                                        World.H_SOBs[Features.GuildWars.TheRightGate.EntityID].Opened = !World.H_SOBs[Features.GuildWars.TheRightGate.EntityID].Opened;
                                        World.H_SOBs[Features.GuildWars.TheRightGate.EntityID].ReSpawn();
                                    }
                                    else
                                    {
                ...
                case 2:
                    {
                        if (GC.MyChar.MyGuild != null)
                        {
                            if (Features.GuildWars.LastWinner != null)
                            {
                                ...
                                {
                                    if (GC.MyChar.Alive)
                                        GC.MyChar.Teleport(1038, 188, 173);
                                }
                                else
                                {
                ...
                case 3:
                    {
                        if (GC.MyChar.MyGuild.Fund >= 2000000)
                        {
                            ...
                            World.H_SOBs[Features.GuildWars.TheRightGate.EntityID].CurHP = World.H_SOBs[Features.GuildWars.TheRightGate.EntityID].MaxHP;
                            World.H_SOBs[Features.GuildWars.TheRightGate.EntityID].Opened = false;
                            World.H_SOBs[Features.GuildWars.TheRightGate.EntityID].ReSpawn();
                            AddText("Congratulations ! The Right Gate have been repaired. The 2,000,000 silvers were deducted from your guild fund.");
                ...
                case 4:
                    {
                        if (GC.MyChar.InventoryContains(721261, 1))
                        {
                            if (MyMath.PointDistance(GC.MyChar.Loc.X, GC.MyChar.Loc.Y, 222, 177) <= 8)
                            {
                                ...
                                if (World.H_SOBs[Features.GuildWars.TheRightGate.EntityID].CurHP > 2500000)
                                {
                                    World.H_SOBs[Features.GuildWars.TheRightGate.EntityID].CurHP -= 2500000;
                                    World.Action(GC.MyChar, Packets.AttackPacket(GC.MyChar.EntityID, 6702, 222, 177, 2500000, (byte)AttackType.Melee).Get);
                                }
                                else
                                {
                                    World.H_SOBs[Features.GuildWars.TheRightGate.EntityID].CurHP = 0;
                                    World.H_SOBs[Features.GuildWars.TheRightGate.EntityID].Opened = true;
                                    World.H_SOBs[Features.GuildWars.TheRightGate.EntityID].ReSpawn();
                                }
                                World.Action(GC.MyChar, Packets.StringPacket(GC.MyChar.EntityID, StringType.Effect, "change").Get);
                                World.Action(World.H_SOBs[Features.GuildWars.TheRightGate.EntityID], Packets.ShakeScreen(Features.GuildWars.TheRightGate.EntityID).Get);
